...
#[derive(Debug)]
pub struct HiveZephyrProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HiveZephyrProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HiveZephyr processing");
    
    let mut processor = HiveZephyrProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HiveZephyrProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HiveZephyrProcessor::new(false);
